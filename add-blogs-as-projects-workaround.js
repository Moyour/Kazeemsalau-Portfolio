...
// Blog posts formatted as projects with category "blog"
...
async function main() {
  console.log('🚀 Adding blog posts as projects to Railway (workaround)...');
  ...
  try {
    ...
    if (blogProjects.length > 0) {
      ...
      console.log('💡 The frontend can be modified to display projects with category "blog" as blog posts');
    }
  } catch (error) {
