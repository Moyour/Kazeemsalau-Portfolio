...
export default function NewsletterSignup() {
  ...
  return (
    <div className="w-full max-w-lg mx-auto">
        <div className="relative overflow-hidden rounded-3xl bg-gray-50 border-2 border-black p-8 shadow-2xl">
        {/* Decorative background elements */}
        <div className="absolute top-0 right-0 w-40 h-40 bg-gray-800/20 rounded-full -translate-y-20 translate-x-20"></div>
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-black/15 rounded-full translate-y-16 -translate-x-16"></div>
        <div className="absolute top-1/2 left-1/2 w-24 h-24 bg-gray-800/10 rounded-full -translate-x-1/2 -translate-y-1/2"></div>
        ...
        <div className="relative">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-3">
              Join the <span className="text-black">Inner Circle</span>
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative">
              ...
              <Input
                ...
                className="w-full pl-12 pr-4 py-4 text-lg border-2 border-gray-200 rounded-xl focus:border-black focus:ring-4 focus:ring-teal-dark/20 transition-all duration-300 bg-white/80 backdrop-blur-sm"
                required
              />
            </div>
            ...
            <Button 
              type="submit" 
              className="w-full bg-black hover:bg-gray-800 text-white font-semibold py-4 px-8 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 text-lg"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
