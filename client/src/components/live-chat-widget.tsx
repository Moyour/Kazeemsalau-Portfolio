    ...
    return (
      <div className="fixed bottom-3 right-3 sm:bottom-4 sm:right-4 z-50">
        <Button
          ...
          className="h-12 w-12 sm:h-14 sm:w-14 rounded-full bg-black hover:bg-black/90 shadow-lg hover:shadow-xl transition-all duration-300"
          size="icon"
        >
  ...
  return (
    <div className="fixed bottom-3 right-3 sm:bottom-4 sm:right-4 z-50 w-72 sm:w-80 md:w-96">
      <Card className="shadow-2xl border-0 bg-white">
        <CardHeader className="bg-black text-white p-3 sm:p-4">
              ...
              <div className="border-t pt-2 sm:pt-3">
                <div className="flex space-x-1 sm:space-x-2">
                  ...
                  <Button
                    ...
                    size="sm"
                    className="bg-cream hover:bg-cream/80 h-8 sm:h-9 w-8 sm:w-9 p-0 text-black"
                  >
